...
const PLANS = {
  ...
  4: [
    { start: [3, 4], segments: [[0, -1, 2], [1, 0, 20], [0, 1, 1], [1, 0, 3]] },
    { start: [5, 4], segments: [[0, -1, 2], [1, 0, 18], [0, 1, 1], [1, 0, 2]] },
    { start: [7, 4], segments: [[0, -1, 2], [1, 0, 16], [0, 1, 2], [1, 0, 3]] },
    { start: [9, 4], segments: [[0, -1, 2], [1, 0, 14], [0, 1, 2], [1, 0, 2]] },
    { start: [11, 4], segments: [[0, -1, 2], [1, 0, 12], [0, 1, 3], [1, 0, 3]] },
    { start: [13, 4], segments: [[0, -1, 2], [1, 0, 10], [0, 1, 3], [1, 0, 2]] },
    { start: [15, 4], segments: [[0, -1, 2], [1, 0, 8], [0, 1, 4], [1, 0, 3]] },
    { start: [17, 4], segments: [[0, -1, 2], [1, 0, 6], [0, 1, 4], [1, 0, 2]] },
    { start: [19, 4], segments: [[0, -1, 2], [1, 0, 4], [0, 1, 5], [1, 0, 3]] },
    { start: [21, 4], segments: [[0, -1, 2], [1, 0, 2], [0, 1, 5], [1, 0, 2]] },
  ],
};
